...
const sampleStories: SeedStory[] = [
  {
    ...
    content:
      "Luna arrived shy but deeply affectionate. After a careful adoption review, she joined a family that wanted a calm dog for weekend hikes and quiet evenings. Within days, Luna had claimed the backseat for trail rides and now spends her mornings on wooded walks followed by long naps in the sun.",
  ...
  },
  {
    ...
    content:
      "Charlie entered foster care to decompress and build confidence outside the shelter. What started as a short placement turned into a lasting bond as his foster family learned how playful, eager, and affectionate he really was. After a few weeks of progress and happy routines, they made the adoption official.",
  ...
  },
  {
    ...
    content:
      "Bella needed a stable home with predictable routines and people who would give her time to settle. After several meet-and-greets, she joined a family with two school-age children who wanted a steady companion. Bella now walks the kids to the bus stop every morning and curls up nearby during homework time.",
  ...
  },
  {
    ...
    content:
      "Whiskers spent weeks politely observing shelter visitors from the back of his kennel, waiting for the right fit. A single adopter looking for a calm companion took the time to visit him repeatedly, and that patience paid off. Whiskers now rules a peaceful apartment with soft beds, low windows, and plenty of afternoon naps.",
  ...
  },
  {
    ...
    content:
      "Oreo came in as a bright, energetic cat who needed daily engagement and a confident adopter. A graduate student looking for a social companion connected with her instantly. Oreo now spends her evenings chasing toys across the apartment and her nights curled beside a stack of textbooks.",
  ...
  },
  {
    ...
    content:
      "Rocky first entered foster care because shelter life was overwhelming for him. In a home setting, his goofy personality came through and his training consistency improved fast. His foster placement eventually turned into a permanent adoption, and Rocky now has a yard, a routine, and people who love his big personality.",
...
const seedStories = async () => {
  try {
    ...
    let author = await User.findOne({ email: "staff@petadopt.com" });
    ...
    console.log(
      `Seeded stories successfully. Created: ${createdCount}, Updated: ${updatedCount}`
    );
    process.exit(0);
  } catch (error) {
